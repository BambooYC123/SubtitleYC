...
window.SubtitleYCI18n = (() => {
  ...
  const zh = {
    ...
    "or": "或",
    "Open Video": "打开视频",
    "Open a video (Ctrl+L)": "打开视频 (Ctrl+L)",
    "Remove Video": "移除视频",
    "Remove Subtitles": "移除字幕",
    "Remove the current video from the preview": "从预览中移除当前视频",
    "Remove current subtitles from the preview": "从预览中移除当前字幕",
    ...
    "Video removed from preview. It remains available in Previous Projects.": "视频已从预览中移除，仍可在以前的项目中找到。",
    "Subtitles removed from preview. They remain available in Previous Projects.": "字幕已从预览中移除，仍可在以前的项目中找到。",
    "Save or undo subtitle changes before removing subtitles": "移除字幕前，请先保存或撤销字幕更改。",
    "Save or undo subtitle changes before removing the video": "移除视频前，请先保存或撤销字幕更改。",
    "Crop: none": "裁剪：无",
    ...
    "System information copied": "系统信息已复制",
    "Checking": "正在检查",
    "Not installed": "未安装",
    "Reset": "重置",
    "Save Settings": "保存设置",
    ...
    "Select text to style it, or leave nothing selected to style the whole cue.": "选择要设置样式的文本，或不选择任何文本以设置整条字幕的样式。",
    "Open a video": "打开视频",
    "Upload a subtitle file": "上传字幕文件",
    "Reload subtitle cues": "重新加载字幕条目",
    "Save subtitle changes": "保存字幕更改",
    "Play or pause the video": "播放或暂停视频",
    "Move back one frame": "后退一帧",
    "Move forward one frame": "前进一帧",
    "Jump to the previous subtitle boundary": "跳转到上一个字幕边界",
    "Jump to the next subtitle boundary": "跳转到下一个字幕边界",
    "Undo subtitle edit": "撤销字幕编辑",
    "Redo subtitle edit": "重做字幕编辑",
    "Delete the selected cue": "删除所选字幕条目",
    "Bold selected text": "将所选文本设为粗体",
    "Italicize selected text": "将所选文本设为斜体",
    "Underline selected text": "为所选文本添加下划线",
    "Choose the selected text color": "选择所选文本的颜色",
    "Remove formatting from selected text": "移除所选文本的格式",
    "Start -": "开始 -",
    "Start +": "开始 +",
    "End -": "结束 -",
    "End +": "结束 +",
